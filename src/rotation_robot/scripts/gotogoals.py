...
class TurtleBot3:
    ...
    def get_lin_x(self, goal_pose, constant = 0.3):
    ...
    def get_ang_z(self, goal_pose, constant = 0.3):   
...
if __name__ == '__main__':
    try:
        tb3 = TurtleBot3()
        goal_poses_matrix = np.array([[0.19, 0.0], [6.80, 0.0], [7.51, 0.13], [8.07, 0.31], [8.68, 0.56], [9.20, 0.82], [9.88, 1.27], [10.78, 2.20], [10.33, 1.66], [11.12, 2.82], [11.33, 3.53], [11.49, 4.29]]) # Define goal poses as a matrix
