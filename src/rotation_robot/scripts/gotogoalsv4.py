...
class TurtleBot3:
    ...
    def move_to_next_goal(self):
        if not self.goal_poses:
        	...
        	self.add_goal_poses_from_matrix(np.array([[0.0, 0.0], [6.80, 0.0], [7.51, 0.13], [8.07, 0.31], [8.68, 0.56], [9.20, 0.82], [9.88, 1.27], [10.33, 1.66], [10.77, 2.20], [11.12, 2.82], [11.33, 3.53], [11.49, 4.29],[11.58, 5.01],[11.58, 12.75],[11.45, 13.43],[9.11, 15.78],[8.52260, 15.95],[-0.94, 15.95],[-1.65, 16.00],[-2.14, 15.67],[-2.39, 15.20],[-2.39, 13.45],[-2.24, 12.74],[-1.84, 12.31],[-1.24, 12.11],[2.25, 12.11],[2.96, 11.93],[3.47, 11.52],[3.59, 10.78],[3.68, 7.72],[3.62, 7.03],[3.40, 6.43],[2.99, 6.05],[2.38, 5.87],[1.80, 5.92],[1.29, 6.19],[-9.50, 12.38],[-9.99, 12.75],[-12.22, 14.90],[-12.77, 15.32],[-13.37, 15.64],[-14.05, 15.91],[-14.75, 16.01],[-15.41, 16.06],[-16.01, 16.00],[-16.60, 15.77],[-17.19, 15.41],[-17.74, 14.86],[-18.13, 14.32],[-18.25, 13.77],[-18.31, 12.99],[-18.36, 11.09],[-18.28, 10.52],[-17.42, 7.49],[-17.31, 5.42],[-17.14, 4.70],[-16.90, 3.99],[-16.61, 3.42],[-16.26, 2.87],[-15.88, 2.43],[-15.49, 2.03],[-14.95, 1.66],[-14.36, 1.41],[-13.75, 1.19],[-13.16, 1.07],[-12.50, 0.99],[-12.00, 0.99],[-8.72, 0.96],[-8.20, 0.84],[-7.72, 0.65],[-7.10, 0.42],[-6.48, 0.25],[-5.85, 0.07],[-5.27, 0.0]]))
        ...
        while self.get_dist(goal_pose) >= tolerance:
            	...
            	if abs(angle) > 0.07 and abs (angle) < 6.23:
            		t.linear.x = 0
            		if angle >= pi:
            			t.angular.z = -0.5
            		...
            		if distance > 1.0:
                		...
                		t.linear.x = LIN_SPD # Increase linear velocity smoothly
                		
            		else:                	
                	
                		t.linear.x = 0.1  # Decrease linear velocity smoothly
            	self.pub.publish(t)
            	self.rate.sleep()
...
if __name__ == '__main__':
    try:
        tb3 = TurtleBot3()
        goal_poses_matrix = np.array([[6.80, 0.0], [7.51, 0.13], [8.07, 0.31], [8.68, 0.56], [9.20, 0.82], [9.88, 1.27], [10.33, 1.66], [10.77, 2.20], [11.12, 2.82], [11.33, 3.53], [11.49, 4.29],[11.58, 5.01],[11.58, 12.75],[11.45, 13.43],[9.11, 15.78],[8.52260, 15.95],[-0.94, 15.95],[-1.65, 16.00],[-2.14, 15.67],[-2.39, 15.20],[-2.39, 13.45],[-2.24, 12.74],[-1.84, 12.31],[-1.24, 12.11],[2.25, 12.11],[2.96, 11.93],[3.47, 11.52],[3.59, 10.78],[3.68, 7.72],[3.62, 7.03],[3.40, 6.43],[2.99, 6.05],[2.38, 5.87],[1.80, 5.92],[1.29, 6.19],[-9.50, 12.38],[-9.99, 12.75],[-12.22, 14.90],[-12.77, 15.32],[-13.37, 15.64],[-14.05, 15.91],[-14.75, 16.01],[-15.41, 16.06],[-16.01, 16.00],[-16.60, 15.77],[-17.19, 15.41],[-17.74, 14.86],[-18.13, 14.32],[-18.25, 13.77],[-18.31, 12.99],[-18.36, 11.09],[-18.28, 10.52],[-17.42, 7.49],[-17.31, 5.42],[-17.14, 4.70],[-16.90, 3.99],[-16.61, 3.42],[-16.26, 2.87],[-15.88, 2.43],[-15.49, 2.03],[-14.95, 1.66],[-14.36, 1.41],[-13.75, 1.19],[-13.16, 1.07],[-12.50, 0.99],[-12.00, 0.99],[-8.72, 0.96],[-8.20, 0.84],[-7.72, 0.65],[-7.10, 0.42],[-6.48, 0.25],[-5.85, 0.07],[-5.27, 0.0]]) # Define goal poses as a matrix
